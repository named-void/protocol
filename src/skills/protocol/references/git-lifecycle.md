...
Перед выполнением этого справочника прочитай `$AGENT_SKILLS_DIR/protocol/SKILL.md`, раздел
`Bootstrap`; он устанавливает `PROTOCOL_SRC` и обязательные справочники среды.
